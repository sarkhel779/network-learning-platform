    ...
    modules: [
      {
        ...
        description: "Learn the essential vocabulary, devices, addresses, and layered models before studying how data moves.",
        lessons: [
          {
            ...
            sections: [
              ...
              { id: "end-and-intermediary-devices", label: "End and intermediary devices", access: "public" },
              { id: "identify-device-roles", label: "Identify device roles", access: "public" },
          ...
          },
          {
            ...
            objective: "Recognize hosts and explain how applications can act as clients, servers, or both.",
            seo: { title: "Hosts, Clients and Servers", description: "Recognize network hosts and understand client, server, and dual application roles." },
          ...
          {
            id: "lesson_hubs", slug: "hubs", title: "Hubs",
            objective: "Explain that a hub repeats an incoming signal to its other ports and why hubs are now mostly historical.",
            seo: { title: "Network Hubs Explained", description: "Learn what a network hub is, why it repeats signals, and why switches replaced it." },
          ...
          {
            id: "lesson_bridges", slug: "bridges", title: "Bridges",
            objective: "Explain how bridges introduced segmentation and basic filtering before modern switches.",
            seo: { title: "Network Bridges Explained", description: "Learn why network bridges introduced segments and basic filtering before modern switches." },
            published: true, estimatedMinutes: 10,
            sections: [
              { id: "what-is-a-bridge", label: "What is a bridge?", access: "public" },
              { id: "why-bridges-were-introduced", label: "Why bridges were introduced", access: "public" },
              { id: "network-segments", label: "Network segments", access: "public" },
              { id: "compare-segments", label: "Compare segments", access: "public" },
              { id: "knowledge-check", label: "Knowledge check", access: "public" },
            ],
          },
          {
            id: "lesson_switches", slug: "switches", title: "Switches",
            objective: "Explain how switches connect local devices and associate devices with ports at an introductory level.",
            seo: { title: "Network Switches Explained", description: "Learn how switches connect devices in a local network and how their role differs from a hub or router." },
            published: true, estimatedMinutes: 12,
            sections: [
              { id: "what-is-a-switch", label: "What is a switch?", access: "public" },
              { id: "switch-ports", label: "Switch ports", access: "public" },
              { id: "more-selective-than-a-hub", label: "More selective than a hub", access: "public" },
              { id: "switches-and-routers", label: "Switches and routers", access: "public" },
              { id: "match-hosts-to-ports", label: "Match hosts to ports", access: "public" },
              { id: "knowledge-check", label: "Knowledge check", access: "public" },
            ],
          },
          {
            id: "lesson_routers_default_gateways_and_network_boundaries", slug: "routers-default-gateways-and-network-boundaries", title: "Routers",
          ...
          },
          {
            ...
            sections: [
              ...
              { id: "mac-addresses", label: "MAC addresses", access: "public" },
              { id: "universal-local-and-individual-group", label: "U/L and I/G bits", access: "public" },
              { id: "ip-addresses", label: "IP addresses", access: "public" },
              { id: "inspect-address-formats", label: "Inspect address formats", access: "public" },
              { id: "knowledge-check", label: "Knowledge check", access: "public" },
            ],
          },
          {
            ...
            seo: { title: "OSI and TCP/IP Models Explained", description: "Connect the OSI and TCP/IP models to practical responsibilities and introductory encapsulation." },
            ...
            sections: [
              ...
              { id: "tcp-ip-model", label: "The TCP/IP model", access: "public" },
              { id: "model-mapping", label: "OSI-to-TCP/IP mapping", access: "public" },
              { id: "encapsulation-lab", label: "Encapsulation and layer matching", access: "public" },
              { id: "knowledge-check", label: "Knowledge check", access: "public" },
            ],
          },
          {
            id: "lesson_computer_network_basics_final_quiz", slug: "computer-network-basics-final-quiz", title: "Computer Network Basics Final Quiz",
            objective: "Check your understanding of the concepts introduced throughout Computer Network Basics.",
            seo: { title: "Computer Network Basics Final Quiz", description: "Check your understanding of hosts, network devices, addressing, and layered network models." },
            published: true, format: "assessment", estimatedMinutes: 12,
            sections: [
              { id: "assessment-overview", label: "Assessment overview", access: "public" },
              { id: "final-module-quiz", label: "Final module quiz", access: "account" },
            ],
          },
        ],
      },
      {
        ...
        lessons: [
          ...
          {
            id: "lesson_unicast_broadcast_and_multicast_communication", slug: "unicast-broadcast-and-multicast-communication", title: "Unicast, Broadcast and Multicast Communication",
            objective: "Identify a transmission's delivery scope and predict which interfaces receive, accept, or forward it.",
            seo: { title: "Unicast, Broadcast and Multicast Explained", description: "Compare unicast, broadcast, and multicast traffic and predict how switches, hosts, and routers handle each delivery type." },
            published: true, estimatedMinutes: 22,
            sections: [
        ...
        lessons: [
          {
            ...
            published: true, estimatedMinutes: 30,
            sections: [
              { id: "what-bgp-is", label: "What BGP is", access: "public" },
              { id: "bgp-message-types", label: "BGP message types", access: "public" },
              { id: "the-bgp-finite-state-machine", label: "The BGP finite state machine", access: "public" },
              { id: "path-attributes", label: "Path attributes", access: "public" },
              { id: "interactive-bgp-session-establishment", label: "Interactive BGP session establishment", access: "public" },
              { id: "the-bgp-decision-process", label: "The BGP decision process", access: "public" },
              { id: "inspect-bgp-evidence", label: "Inspect BGP evidence", access: "account" },
              { id: "guided-bgp-path-selection-practice", label: "Guided BGP path-selection practice", access: "account" },
              { id: "troubleshoot-bgp", label: "Troubleshoot BGP", access: "account" },
              { id: "knowledge-check-summary", label: "Knowledge check and summary", access: "account" },
              { id: "pro-deep-dive", label: "Pro Deep Dive", access: "pro", preview: "BGP communities, route reflectors, confederations, route dampening, and multiprotocol BGP." },
            ],
          },
        ],
      },
