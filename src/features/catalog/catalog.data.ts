    ...
    modules: [
      ...
      },
      {
        ...
        lessons: [
          ...
          {
            id: "lesson_routing_protocols", slug: "routing-protocols", title: "Routing Protocols",
            objective: "Explain why dynamic routing protocols exist, distinguish distance-vector from link-state operation, and describe what RIP, OSPF, EIGRP, and BGP each optimize for.",
            seo: { title: "Routing Protocols", description: "Learn why routing protocols exist and how RIP, OSPF, EIGRP, and BGP differ in operation, scale, and convergence." }, estimatedMinutes: 25,
            published: true,
            sections: [
              { id: "why-routing-protocols-exist", label: "Why routing protocols exist", access: "public" },
              { id: "static-vs-dynamic-routing", label: "Static vs. dynamic routing", access: "public" },
              { id: "distance-vector-vs-link-state", label: "Distance-vector vs. link-state", access: "public" },
              { id: "rip-basics", label: "RIP basics", access: "public" },
              { id: "ospf-basics", label: "OSPF basics", access: "public" },
              { id: "bgp-basics", label: "BGP basics", access: "public" },
              { id: "interactive-protocol-selection", label: "Interactive protocol selection", access: "public" },
              { id: "choosing-a-routing-protocol", label: "Choosing a routing protocol", access: "public" },
              { id: "eigrp-basics", label: "EIGRP basics", access: "account" },
              { id: "inspect-routing-protocol-evidence", label: "Inspect routing protocol evidence", access: "account" },
              { id: "guided-protocol-selection-practice", label: "Guided protocol-selection practice", access: "account" },
              { id: "troubleshoot-routing-protocols", label: "Troubleshoot routing protocols", access: "account" },
              { id: "knowledge-check-summary", label: "Knowledge check and summary", access: "account" },
              { id: "pro-deep-dive", label: "Pro Deep Dive", access: "pro", preview: "Trace BGP best-path selection, OSPF LSA types and NSSAs, EIGRP's DUAL algorithm, route redistribution, and BGP route dampening." },
            ],
          },
          {
