...
const fast = [
  ...
  step({ id: "later-one", title: "Segment 5 arrives above the gap", explanation: "Bytes 1201–1300 arrive out of order; the receiver holds them but still needs 1101–1200.", sendLeft: 1101, nextToSend: 1301, sendRight: 1601, cumulativeAck: 1101, sackBlocks: [{ left: 1201, right: 1301 }], packet: "DATA 1201–1300", direction: "forward" }),
  step({ id: "first-duplicate-ack", title: "First duplicate ACK", explanation: "ACK 1101 remains the cumulative answer. SACK [1201, 1301) reports the received bytes beyond the gap; 1301 is excluded.", sendLeft: 1101, nextToSend: 1301, sendRight: 1601, cumulativeAck: 1101, duplicateAcks: 1, sackBlocks: [{ left: 1201, right: 1301 }], packet: "1st duplicate ACK 1101", direction: "reverse" }),
  step({ id: "later-two", title: "Segment 6 arrives above the gap", explanation: "Bytes 1301–1400 join the out-of-order block already held by the receiver.", sendLeft: 1101, nextToSend: 1401, sendRight: 1601, cumulativeAck: 1101, duplicateAcks: 1, sackBlocks: [{ left: 1201, right: 1401 }], packet: "DATA 1301–1400", direction: "forward" }),
  step({ id: "out-of-order", title: "Second duplicate ACK", explanation: "ACK 1101 remains unchanged. The SACK block expands to [1201, 1401), showing that later bytes through 1400 arrived.", sendLeft: 1101, nextToSend: 1401, sendRight: 1601, cumulativeAck: 1101, duplicateAcks: 2, sackBlocks: [{ left: 1201, right: 1401 }], packet: "2nd duplicate ACK 1101", direction: "reverse" }),
  step({ id: "later-three", title: "Segment 7 arrives above the gap", explanation: "Bytes 1401–1500 extend the receiver's held out-of-order data.", sendLeft: 1101, nextToSend: 1501, sendRight: 1601, cumulativeAck: 1101, duplicateAcks: 2, sackBlocks: [{ left: 1201, right: 1501 }], packet: "DATA 1401–1500", direction: "forward" }),
  step({ id: "third-duplicate-ack", title: "Third duplicate ACK", explanation: "ACK 1101 remains unchanged. SACK [1201, 1501) reports bytes through 1500 already received. The third duplicate ACK gives the sender the classic fast-retransmit signal.", sendLeft: 1101, nextToSend: 1501, sendRight: 1601, cumulativeAck: 1101, duplicateAcks: 3, sackBlocks: [{ left: 1201, right: 1501 }], packet: "3rd duplicate ACK 1101", direction: "reverse" }),
