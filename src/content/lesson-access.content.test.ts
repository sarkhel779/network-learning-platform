...
describe("public lesson source boundaries", () => {
  ...
  it("preserves both advanced Hosts checks and all five interview answers in the archive", () => {
    const source = readFileSync(join(process.cwd(), "docs/reference/hosts-and-network-devices-advanced-reference.mdx"), "utf8");
