...
insert into public.lesson_progress_items (pathway_id, lesson_id, content_version, item_id, ordinal, kind, label, anchor, required) values
  ...
  ('path_networking_foundations', 'lesson_hosts_and_network_devices', 1, 'hosts_and_network_devices_interactive_explore_topology', 3, 'interactive', 'Explore the topology', 'explore-topology', true),
  ...
  ('path_networking_foundations', 'lesson_cables_fibre_wireless_and_network_connections', 1, 'cables_fibre_wireless_and_network_connections_interactive_diagnose_link_symptoms', 8, 'interactive', 'Diagnose link symptoms', 'diagnose-link-symptoms', true),
  ...
  ('path_networking_foundations', 'lesson_hubs_bridges_and_switches', 1, 'hubs_bridges_and_switches_interactive_diagnose_local_switching_symptoms', 8, 'interactive', 'Diagnose local switching symptoms', 'diagnose-local-switching-symptoms', true),
  ...
  ('path_networking_foundations', 'lesson_unicast_broadcast_and_multicast_communication', 1, 'unicast_broadcast_and_multicast_communication_interactive_diagnose_delivery_scope', 9, 'interactive', 'Diagnose delivery-scope scenarios', 'diagnose-delivery-scope', true),
  ...
  ('path_networking_foundations', 'lesson_routers_default_gateways_and_network_boundaries', 1, 'routers_default_gateways_and_network_boundaries_interactive_diagnose_gateway_boundary_problems', 9, 'interactive', 'Diagnose gateway and boundary problems', 'diagnose-gateway-boundary-problems', true),
  ...
  ('path_networking_foundations', 'lesson_access_points_modems_onts_and_firewalls', 1, 'access_points_modems_onts_and_firewalls_interactive_identify_device_roles', 7, 'interactive', 'Identify device roles', 'identify-device-roles', true),
  ('path_networking_foundations', 'lesson_access_points_modems_onts_and_firewalls', 1, 'access_points_modems_onts_and_firewalls_interactive_diagnose_edge_failures', 8, 'interactive', 'Diagnose edge failures', 'diagnose-edge-failures', true),
  ...
  ('path_networking_foundations', 'lesson_first_packet_journey_through_a_small_network', 1, 'first_packet_journey_through_a_small_network_interactive_match_evidence_to_the_journey', 6, 'interactive', 'Match evidence to the journey', 'match-evidence-to-the-journey', true),
  ('path_networking_foundations', 'lesson_first_packet_journey_through_a_small_network', 1, 'first_packet_journey_through_a_small_network_interactive_troubleshoot_the_first_failed_hop', 7, 'interactive', 'Troubleshoot the first failed hop', 'troubleshoot-the-first-failed-hop', true),
  ...
  ('path_networking_foundations', 'lesson_ethernet_frames_and_mac_addresses', 1, 'ethernet_frames_and_mac_addresses_interactive_inspect_frame_evidence', 6, 'interactive', 'Inspect frame evidence', 'inspect-frame-evidence', true),
  ('path_networking_foundations', 'lesson_ethernet_frames_and_mac_addresses', 1, 'ethernet_frames_and_mac_addresses_interactive_diagnose_frame_problems', 7, 'interactive', 'Diagnose frame problems', 'diagnose-frame-problems', true),
  ...
  ('path_networking_foundations', 'lesson_how_switches_learn_and_forward', 1, 'how_switches_learn_and_forward_interactive_diagnose_switching_behaviour', 7, 'interactive', 'Diagnose switching behaviour', 'diagnose-switching-behaviour', true),
  ...
  ('path_networking_foundations', 'lesson_arp_and_local_delivery', 1, 'arp_and_local_delivery_interactive_inspect_neighbour_evidence', 6, 'interactive', 'Inspect neighbour evidence', 'inspect-neighbour-evidence', true),
  ('path_networking_foundations', 'lesson_arp_and_local_delivery', 1, 'arp_and_local_delivery_interactive_troubleshoot_arp_methodically', 7, 'interactive', 'Troubleshoot ARP methodically', 'troubleshoot-arp-methodically', true),
  ...
  ('path_networking_foundations', 'lesson_vlans_access_ports_and_trunks', 1, 'vlans_access_ports_and_trunks_interactive_solve_vlan_reachability', 8, 'interactive', 'Solve VLAN reachability', 'solve-vlan-reachability', true),
